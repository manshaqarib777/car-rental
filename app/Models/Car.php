...
{
    protected $fillable = ['id', 'user_id', 'title', 'brand_id', 'year', 'mileage', 'regular_price', 'sale_price', 'search_price', 'negotiable', 'brand_model_id', 'category_id','subcategory_id', 'body_type_id', 'fuel_type_id', 'transmission_type_id', 'condtion_id', 'featured_image', 'description', 'label', 'value', 'top_speed', 'currency_code', 'currency_symbol', 'created_at', 'updated_at'];
