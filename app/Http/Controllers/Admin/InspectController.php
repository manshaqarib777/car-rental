...
class InspectController extends Controller
{
    ...
    {
         $datas = User::orderBy('id','desc')->where('type',3)->get();
         ...
         return Datatables::of($datas)
                            ...
                            ->addColumn('action', function(User $data) {
                                return '<div class="action-list"><a data-href="' . route('admin-inspect-edit',$data->id) . '" class="edit" data-toggle="modal" data-target="#modal1"> <i class="fas fa-edit"></i>Edit</a></div>';
                            })
                            ->rawColumns(['username','email','phone','status', 'action'])
    ...
    public function store(Request $request)
    {
        ...
        //--- Redirect Section
        $msg = 'New Inspector Added Successfully.';
    ...
    public function edit($id)
    {
        ...
        return view('admin.inspect.edit',compact('data', 'cats'));
    }
