                        ...
                        <div class="row">
                          <div class="col-lg-7 offset-lg-3">
                            <div class="row">
                              ...
                              <div class="col-lg-6">
                                <h4 class="heading mb-0">Sub Categories</h4>
                                <select class="searchable-select input-field" name="subcategory_id" id="selectSubCatogories">
                                  <option value="Select a brand" disabled selected>Select a Sub Category</option>
                                  @foreach ($subcats as $key => $cat)
                                    <option value="{{ $cat->id }}" {{ $car->subcategory_id == $cat->id ? 'selected' : '' }}>{{ $cat->name }}</option>
                                  @endforeach
                                </select>
                              </div>
                            </div>
  ...
  <script type="text/javascript">
    ...
    <script>
      ...
      function getsubcategories(cat_id) {
        var url = '{{ url('/') }}' + '/car/'+cat_id+'/getsubcategories';
        // console.log(url);
        $.get(url, function(data) {
          // console.log(data);
