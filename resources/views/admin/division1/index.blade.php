...
@section('content')
					<input type="hidden" id="headerdata" value="Division1">
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">Division1</h4>
										<ul class="links">
											<li>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin.division1.fetch',$code) }}',
               columns: [
                  { data: 'code', name: 'code' },
                  { data: 'name', name: 'name' },
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="{{route('admin.division1.create',$code)}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
