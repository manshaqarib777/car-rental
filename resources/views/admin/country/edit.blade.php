                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin.country.update',$country->id)}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="box-body row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="code" value="{{$country->code}}" placeholder="Enter the country code (ISO Code)" class="form-control">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="name" value="{{$country->name}}" placeholder="Local Name" class="form-control">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="asciiname" value="{{$country->asciiname}}" placeholder="Enter the country name (In English)" class="form-control">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="capital" value="{{$country->capital}}" placeholder="Capital" class="form-control">
                                    ...
                                    <select name="continent_code" style="width: 100%" class="form-control searchable-select">
                                        <option value="Select a Continent" disabled selected>Select a Continent</option>
                                          @foreach ($continents as $key => $continent)
                                            <option value="{{ $continent->id }}" {{($country->continent_code==$continent->id)?'selected':'' }}>{{ $continent->name }}</option>
                                          @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="tld" value="{{$country->tld}}" placeholder="Enter the country tld (E.g. .bj for Benin)" class="form-control">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="phone" value="{{$country->phone}}" placeholder="Enter the country phone ind. (E.g. +229 for Benin)" class="form-control">
                                    ...
                                    <select name="currency_code" style="width: 100%" class="form-control searchable-select">
                                        <option value="Select a Currency Code" disabled selected>Select a Currency Code</option>
                                          @foreach ($currencies as $key => $currency)
                                            <option value="{{ $currency->id }}" {{($country->currency_code==$currency->id)?'selected':'' }}>{{ $currency->code }}</option>
                                          @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="languages" value="{{$country->languages}}" placeholder="eg. en,de,fr,it" class="form-control">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input type="checkbox" value="1" name="admin_field_active" {{($country->admin_field_active==1)?'checked':'' }}> Active Administrative Division's Field
                                        </label>
