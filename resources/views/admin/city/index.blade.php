							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											@endif
											@if(!empty($subadmin1_code))
											<li>
												<a href="{{ route('admin.division1',$code) }}">Division1</a>
											</li>
											@endif
											@if(!empty($subadmin2_code))
											<li>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin.city.fetch',$code) }}',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="{{route('admin.city.create',$code)}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
