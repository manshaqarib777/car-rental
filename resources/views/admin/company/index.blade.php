...
@section('content')
					<input type="hidden" id="headerdata" value="Company">
							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="{{ route('admin-company-index') }}">Company Management</a>
											</li>
										</ul>
								</div>
							</div>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-company-datatables') }}',
               columns: [
                 	{ data: 'username', name: 'username' },
					{ data: 'email', name: 'email' },
					{ data: 'phone', name: 'phone', searchable: false, orderable: false },
					{ data: 'feature', name: 'feature', searchable: false, orderable: false },
