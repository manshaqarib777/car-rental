...
@section('content')
        <section class="testimonial" style=" background-image: url({{asset('assets/front/images/'.$ps->topbanner_back_image) }});">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-8 col-md-10">
					<div class="row">
                        ...
                        <div class="wt-bannerimages">
                            <figure class="wt-bannermanimg" data-tilt>
                                <img src="{{asset('assets/front/images/'.$ps->topbanner_front_image) }}" alt="">
                            </figure>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-7">
                        <div class="wt-bannercontent">
                            <div class="wt-bannerhead">
                                <div class="wt-title">
                                    <h1><span>{{$ps->topbanner_heading}}</span>{{$ps->topbanner_small_des}}</h1>
                                </div>
                                <div class="wt-description">
                                    <p>{{$ps->topbanner_full_des}}</p>
                                </div>
                            </div>
                            <div class="wt-videoholder">
                                <div class="wt-videoshow">
                                    <a data-rel="prettyPhoto[video]" href="{{$ps->top_banner_video_link}}"><i class="fa fa-play"></i></a>
                                </div>
					...
					{{-- <div class="people">
							<div class="img">
									<img src="{{asset('assets/front/images/heroarea-img.jpg') }}" alt="">
							</div>
							<h4 class="title">sdklasjkdljaskljd</h4>
							<p class="designation">kljskldjklasdl</p>
						</div>
	...
	<section class="hero-area">
		<img class="cars" src="{{  asset('assets/front/images/'.$ps->image) }}" alt="">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="content">
	...
	<section class="testimonial" style=" background-image: url({{asset('assets/front/images/'.$ps->testimonial_bg) }});">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-7 col-md-10">
					<div class="section-heading">
