...
<head>
    ...
    <link href="{{ asset('assets/admin/css/component-custom-switch.min.css') }}" rel="stylesheet" /> @yield('styles')
                    ...
                    <ul class="list-unstyled components" id="accordion">
                        ...
                        <li>
                            ...
                            <ul class="collapse list-unstyled" id="specs" data-parent="#accordion">
                                ...
                                <li>
                                    <a href="{{ route('admin-subcat-index') }}"><span>Sub Category Management</span></a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="collapse list-unstyled @if(request()->path() == 'admin/individual' || request()->path() == 'admin/company' || request()->path() == 'admin/inspect') show  @endif" id="seller_management" data-parent="#accordion">
                                <li class="@if(request()->input('type') == 'individual') active  @endif">
                                    <a href="{{ route('admin-user-index') . '?type=individual' }}"><span>Individual</span></a>
                                </li>
                                <li class="@if(request()->input('type') == 'company') active  @endif">
                                    <a href="{{ route('admin-company-index') . '?type=company' }}"><span>Companies</span></a>
                                </li>
                                <li class="@if(request()->input('type') == 'inspect') active  @endif">
                                    <a href="{{ route('admin-inspect-index') . '?type=inspect' }}"><span>Inspectors</span></a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="collapse list-unstyled @if(request()->path() == 'manage/role' || request()->path() == 'roles' || request()->path() == 'permissions') show  @endif" id="role" data-parent="#accordion">
                                <li class="@if(request()->input('type') == 'managerole') active  @endif">
                                    <a href="{{ route('admin.manage.role') . '?type=managerole' }}"><span>Role Managemnet</span></a>
                                </li>
                                <li class="@if(request()->input('type') == 'role') active  @endif">
                                    <a href="{{ route('admin.roles') . '?type=role' }}"><span>Roles</span></a>
                                </li>
                                <li class="@if(request()->input('type') == 'permission') active  @endif">
                                    <a href="{{ route('admin.permissions') . '?type=permission' }}"><span>Permissions</span></a>
                                </li>
                            </ul>
                        </li>	
                        <li>
                            ...
                            <ul class="collapse list-unstyled @if(request()->path() == 'admin/countries' || request()->path() == 'admin/currencies') show  @endif" id="international" data-parent="#accordion">
                                <li class="@if(request()->input('type') == 'country') active  @endif">
                                    <a href="{{ route('admin.countries') . '?type=country' }}"><span>Countries</span></a>
                                </li>
                                <li class="@if(request()->input('type') == 'currency') active  @endif">
                                    <a href="{{ route('admin.currencies') . '?type=currency' }}"><span>Currencies</span></a>
                                </li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="collapse list-unstyled" id="menu" data-parent="#accordion">
                                <li>
                                    <a href="{{ route('admin-hiw-index') }}"><span>How it Works Page</span></a>
                                </li>
                                <li>
