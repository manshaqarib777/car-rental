							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="<?php echo e(route('admin.countries')); ?>">Country</a>
											</li>
										</ul>
								</div>
							</div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '<?php echo e(route('admin.country.fetch')); ?>',
               columns: [
                  { data: 'code', name: 'code' },
                  { data: 'name', name: 'name' },
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="<?php echo e(route('admin.country.create')); ?>" id="add-data" data-toggle="modal" data-target="#modal1">'+
