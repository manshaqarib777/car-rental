...
<head>
		...
		<link href="<?php echo e(asset('css/app.css')); ?>"></link>
			...
			<div class="page-main">
								...
								<ul class="list">
									...
									<li class="login-profile-area">
										<a class="dropdown-toggle-1" href="javascript:;">
											<div class="user-img">
												<img src="<?php echo e(Auth::user()->image ? asset('assets/user/propics/'.Auth::user()->image ):asset('assets/user/blank.png')); ?>" alt="">
											</div>
										</a>
										<div class="dropdown-menu">
											<div class="dropdownmenu-wrapper">
												<ul>
														<h5><?php echo e($langg->lang75); ?> <?php echo e(Auth::user()->username); ?>!</h5>
													<li>
														<a href="<?php echo e(route('user.profile')); ?>"><i class="fas fa-user"></i> <?php echo e($langg->lang76); ?></a>
													</li>
													<li>
														<a href="<?php echo e(route('user.password')); ?>"><i class="fas fa-cog"></i> <?php echo e($langg->lang77); ?></a>
													</li>
													<li>
														<a href="<?php echo e(route('user.password')); ?>"><i class="fas fa-cog"></i> <?php echo e($langg->lang77); ?></a>
													</li>
													<li>
														<a href="<?php echo e(route('user-logout')); ?>"><i class="fas fa-power-off"></i> <?php echo e($langg->lang74); ?></a>
													</li>
												</ul>
											</div>
										</div>
				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<?php if(\Auth::guard('web')->user()->type==3): ?>
						<ul class="list-unstyled components" id="accordion">
							...
							<li>
								<a href="<?php echo e(route('user.messages')); ?>"><i class="fa fa-envelope"></i> Messages </a>
							</li>
						</ul>
						<?php else: ?>
						<ul class="list-unstyled components" id="accordion">
							<li>
								<a href="<?php echo e(route('user-dashboard')); ?>" class="wave-effect active"><i class="fa fa-home mr-2"></i><?php echo e($langg->lang68); ?></a>
							</li>

							<li><a href="<?php echo e(route('user.car.create')); ?>"><i class="fas fa-plus"></i> <?php echo e($langg->lang69); ?></a></li>
							<li><a href="<?php echo e(route('user.car.index')); ?>"><i class="fas fa-table"></i> <?php echo e($langg->lang70); ?></a></li>
							<li><a href="<?php echo e(route('user.car.index', 'featured')); ?>"><i class="fas fa-table"></i> <?php echo e($langg->lang71); ?></a></li>
							<li><a href="<?php echo e(route('user-social-index')); ?>"><i class="fas fa-link"></i><?php echo e($langg->lang72); ?></a></li>
							<li><a href="<?php echo e(route('user-package')); ?>"><i class="fas fa-box-open"></i><?php echo e($langg->lang73); ?></a></li>
							<li>
								<a href="<?php echo e(route('user.messages')); ?>"><i class="fa fa-envelope"></i> Messages </a>
							</li>
							<li><a href="<?php echo e(route('user-logout')); ?>"><i class="fas fa-sign-out-alt"></i><?php echo e($langg->lang74); ?></a></li>
						</ul>
						<?php endif; ?>
					</nav>
