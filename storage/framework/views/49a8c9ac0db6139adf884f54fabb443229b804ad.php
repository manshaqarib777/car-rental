							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="<?php echo e(route('admin.division1',$country_code)); ?>">Division1</a>
											</li>
											<li>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '<?php echo e(route('admin.division2.fetch',$code)); ?>',
               columns: [
                  { data: 'code', name: 'code' },
                  { data: 'name', name: 'name' },
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="<?php echo e(route('admin.division2.create',$code)); ?>" id="add-data" data-toggle="modal" data-target="#modal1">'+
